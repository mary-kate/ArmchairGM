...
" );
	...
	public function getEditButtons(&$tabindex) {
		...
		//<button id=\"wpSave\" name=\"wpSave\" type=\"submit\" tabindex=\"{$tabindex}\" accesskey=\"".wfMsg('accesskey-save')."\" tite=\"".wfMsg('tooltip-save')." [".wfMsg( 'accesskey-save' )."]\"><img src=\"images/common/saveIcon.gif\"/> ".wfMsg('savearticle')."</button>";
		...
		if ( $wgLivePreview && $wgUser->getOption( 'uselivepreview' ) ) {
			...
			//<button id=\"wpPreview\" name=\"wpPreview\" type=\"submit\" tabindex=\"{$tabindex}\" tite=\"".wfMsg('tooltip-preview')." [".wfMsg( 'accesskey-preview' )."]> ".wfMsg('showpreview')."</button>
			...
			//<button id=\"wpLivePreview\" name=\"wpLivePreview\" type=\"submit\" tabindex=\"{$tabindex}\" accesskey=\"".wfMsg('accesskey-preview')."\" onclick=\"{$this->doLivePreviewScript()}\"><img src=\"images/common/previewIcon.gif\"/> ".wfMsg('showlivepreview')."</button>
		} else {
			$temp = array(
				'id'        => 'wpPreview',
				'name'      => 'wpPreview',
			...
			$buttons['preview'] = wfElement('input', $temp, '');
			//<button title=\"".wfMsg( 'tooltip-preview' )." [".wfMsg( 'accesskey-preview' )."]\" id=\"wpPreview\" name=\"wpPreview\" type=\"submit\" tabindex=\"{$tabindex}\" accesskey=\"".wfMsg('accesskey-preview')."\"><img src=\"images/common/previewIcon.gif\"/> ".wfMsg('showpreview')."</button>";
			$buttons['live'] = '';
		}
		...
		//<button title=\"".wfMsg( 'tooltip-diff' )." [".wfMsg( 'accesskey-diff' )."]\" id=\"wpDiff\" name=\"wpDiff\" tabindex=\"{$tabindex}\" accesskey=\"".wfMsg('accesskey-diff')."\" type=\"submit\"><img src=\"images/common/showChangesIcon.gif\"/> ".wfMsg('showdiff')."</button>";
