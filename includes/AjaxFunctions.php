...
Global $IP;
Require_once ( $IP . '/extensions/wikia/AjaxFunctions.php' );

Require_once ( $IP . '/extensions/wikia/AjaxFunctionsNY_General.php' );
Require_once ( $IP . '/extensions/wikia/Vote/Vote_AjaxFunctions.php' ); //converted
Require_once ( $IP . '/extensions/wikia/Comments/Comments_AjaxFunctions.php' ); //converted
Require_once ( $IP . '/extensions/wikia/UserRelationship/Relationship_AjaxFunctions.php' ); //converted
Require_once ( $IP . '/extensions/wikia/ListRatings/ListRatings_AjaxFunctions.php' ); //not used?
Require_once ( $IP . '/extensions/wikia/UserProfile/UserProfile_AjaxFunctions.php' ); // converted
Require_once ( $IP . '/extensions/wikia/Poll/Poll_AjaxFunctions.php' );
Require_once ( $IP . '/extensions/wikia/SportsGames/PickGame_AjaxFunctions.php' );
Require_once ( $IP . '/extensions/wikia/Jeff/PlayerUpdater_AjaxFunctions.php' );
#Require_once ( $IP . '/extensions/ListPages/ListPages_AjaxFunctions.php' );
#Require_once ( $IP . '/extensions/wikia/AjaxFunctionsNY_SiteScout.php' );
Require_once ( $IP . '/extensions/wikia/QuizGame/QuestionGame_AjaxFunctions.php' );
Require_once ( $IP . '/extensions/wikia/ImageRating/ImageRating_AjaxFunctions.php' ); // converted
Require_once ( $IP . '/extensions/wikia/FlickrImport/FlickrImport_AjaxFunctions.php' );
Require_once ( $IP . '/extensions/wikia/VideoImport/VideoImport_AjaxFunctions.php' );
Require_once ( $IP . '/extensions/wikia/JSON/JSONAjaxFunction.php' );
Require_once ( $IP . '/extensions/wikia/SectionDisplay/SectionDisplay.php' );
Require_once ( $IP . '/extensions/wikia/ContentWidget/Widget.php' );
Require_once ( $IP . '/extensions/wikia/ContentWidget/Mobile.php' );
Require_once ( $IP . '/extensions/wikia/LinkFilter/LinkFilter_AjaxFunctions.php' );
Require_once ( $IP . '/extensions/wikia/MarchMadness/MarchMadness_Ajax.php' );
