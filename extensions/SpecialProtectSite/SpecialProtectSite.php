...
if(defined('MEDIAWIKI'))
{
  ...
  function wfSetupProtectsite()
  {
    ...
    if (is_array($prot))
    {
      ...
      if (1==1) // cheap hack to fix this cheap hack  -------(substr($wgVersion,0,3) == '1.8')
      {
        ...
        $wgGroupPermissions['user']['upload'] = !($prot['move'] == 1);
        $wgGroupPermissions['user']['reupload'] = !($prot['move'] == 1);
        $wgGroupPermissions['user']['reupload-shared'] = !($prot['move'] == 1);
      }
      else
      {
