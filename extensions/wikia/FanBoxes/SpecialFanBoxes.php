...
//colorpicker
	...
	if( !$wgUser->isLoggedIn() ){
		...
		$output .= "<div class=\"fanbox-nav\">
				...
				<p><a href=\"" . $top_title->escapeFullURL("cat=User") . "\">" . wfMsgForContent("user_fanboxes_link") . "</a></p>
				</div>";
		...
		if($fanboxid){
				...
				<tr><td id=\"fanBoxLeftSideContainer\" bgcolor=\"".$update_fan->getFanBoxLeftBgColor()."\">
						<table cellspacing=\"0\" width=\"55px\" height=\"63px\">
							<tr>
							<td bgcolor=\"".$update_fan->getFanBoxLeftBgColor()."\" id=\"fanBoxLeftSideOutput2\" style=\"color:".$update_fan->getFanBoxLeftTextColor()."; font-size:$leftfontsize\">".$fantag_leftside."</td>					
							</tr>
						</table>
						</td>
					<td id=\"fanBoxRightSideContainer\" bgcolor=\"".$update_fan->getFanBoxRightBgColor()."\">
							<table cellspacing=\"0\" >
								<tr>
								<td bgcolor=\"".$update_fan->getFanBoxRightBgColor()."\" id=\"fanBoxRightSideOutput2\" style=\"color:".$update_fan->getFanBoxRightTextColor()."; font-size:$rightfontsize\">".$update_fan->getFanBoxRightText()." </td>
								</tr>
							</table>
					</td> 
				</table>
