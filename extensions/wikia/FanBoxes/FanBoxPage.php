...
class FanBoxPage extends Article{
	...
	function view(){
		...
		$output .= "<h1>{$fanboxtitle->getPrefixedText()}</h1>";
		...
		$output .= "<div class=\"user-embed-tag\">".$this->getEmbedThisTag()."</div>";

				
		$output.= "<div class=\"users-with-fanbox\"><h2>". wfMsgForContent( 'fanbox_users_with_fanbox' )."</h2>".$this->fanBoxHolders()."</div>";
