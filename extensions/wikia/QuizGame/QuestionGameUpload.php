...
class QuestionGameUploadForm extends UploadForm{
	...
	function mainUploadForm( $msg='' ) {
		...
		$wgOut->addHTML( "
			...
			<form id='upload' name='upload' onSubmit=\"return submitForm()\" method='post' enctype='multipart/form-data' action=\"$action\">
				...
				<tr>
					<td>
					<input tabindex='9'  type='Submit' class='startButton' id='wpUpload' name='wpUpload' value=\"" . wfMsgForContent( 'quiz_upload' ) . "\" />
					</td>
				</tr>
				</table>
			</form>
	...
	function showSuccess() {
		...
		$article->doEdit(  "{{Image Top}}\n\n{{Image Bottom}}\n[[Category:Profile Pictures]]\n[[Category:Profile Pictures by User {$user_name}]]", "aprofile image creation",EDIT_SUPPRESS_RC );
