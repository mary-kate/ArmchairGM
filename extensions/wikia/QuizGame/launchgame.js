	...
	function showEditMenu(){
		document.location = "index.php?title=Special:QuizGameHome&questionGameAction=editItem&quizGameId=" + 
	...
	function flagQuestion(){
		...
		var url = "index.php?action=ajax";
		var postBody = 'rs=wfQuestionGameAdmin&rsargs[]=flagItem&rsargs[]=' + $( 'quizGameKey' ).value + '&rsargs[]=' + $( 'quizGameId' ).value;
		var callback = 
		{
	...
	function go_to_quiz(id){
		window.location = 'index.php?title=Special:QuizGameHome&questionGameAction=launchGame&permalinkID='+id
	}
	...
	function pause_quiz(){
		...
		if(continue_timer)clearTimeout(continue_timer)
			$("quiz-controls").innerHTML = "<a  href='javascript:go_to_next_quiz();' class='stop-button'>" + __quiz_pause_continue__ + "</a> - <a href='index.php?title=Special:QuizLeaderBoard' class='stop-button'>" + __quiz_pause_view_leaderboard__ + "</a> - <a href='index.php?title=Special:QuizGameHome&questionGameAction=createForm' class='stop-button'>" + __quiz_pause_create_question__ + "</a><br><br><a href='index.php?title=Main_Page' class='stop-button'>" + __quiz_main_page_button__ + "</a>";
	}
