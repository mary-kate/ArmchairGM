	...
	function clearRating(id,num,prev_rating,voted){
		...
		for (var x=1;x<=MaxRating;x++) {     
			...
			if(!num && old_rating >= x){
				$("rating_" + id + "_" + x).src = "http://images.wikia.com/common/wikiany/images/star_" + star_on + ".gif?1";
			}else{
				$("rating_" + id + "_" + x).src = "http://images.wikia.com/common/wikiany/images/star_off.gif?1";
			}
		}
	}
	...
	function updateRating(id,num,prev_rating) {
		...
		for (var x=1;x<=num;x++) {
			$("rating_" + id + "_" + x).src = "http://images.wikia.com/common/wikiany/images/star_voted.gif?1";
		}
		last_id = id;
	}
