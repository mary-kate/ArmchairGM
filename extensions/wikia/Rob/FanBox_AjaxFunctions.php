...
function wfMessageAddRemoveUserPage($addremove, $id){
	global $wgUser, $wgOut, $IP, $wgMessageCache; 
	$out = "";
	...
	$out.= "<div class=\"show-addremove-message\">". wfMsgForContent( 'fanbox_successful_add' ) ."</div>";
	...
	$out.= "<div class=\"show-addremove-message\">". wfMsgForContent( 'fanbox_successful_remove' ) ."</div>";
	}
...
$wgAjaxExportList [] = 'wfMessageAddRemoveUserPageHalf';
function wfMessageAddRemoveUserPageHalf($addremove, $id){
	global $wgUser, $wgOut, $IP, $wgMessageCache; 
	$out = "";
	require_once("$IP/extensions/wikia/Rob/FanBoxesClass.php");
	...
	$out.= "<div class=\"show-addremove-message-half\">". wfMsgForContent( 'fanbox_successful_add' ) ."</div>";
	...
	$out.= "<div class=\"show-addremove-message-half\">". wfMsgForContent( 'fanbox_successful_remove' ) ."</div>";
	}
