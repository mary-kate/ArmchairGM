...
function displayLeftSide() {
	...
	document.getElementById("fanBoxLeftSideOutput2").style.padding = "5px"	
...
function showMessage(addremove, title, fantagid){
		...
		YAHOO.widget.Effects.Hide('show-message-container');
		var callback = {
			success: function( oResponse ) {
				$('show-message-container').innerHTML = oResponse.responseText;
				YAHOO.widget.Effects.Appear('show-message-container',{duration:2.0} );
			}
		};
...
function showAddRemoveMessageUserPage(addremove,id){
		var url = "index.php?action=ajax";
		var pars = 'rs=wfMessageAddRemoveUserPage&rsargs[]=' + addremove + '&rsargs[]=' + id
...
function showAddRemoveMessageUserPageHalf(addremove,id){
		var url = "index.php?action=ajax";
		var pars = 'rs=wfMessageAddRemoveUserPageHalf&rsargs[]=' + addremove + '&rsargs[]=' + id
		YAHOO.widget.Effects.Hide('show-message-container'+id);
		var callback = {
			success: function( oResponse ) {
				$('show-message-container'+id).innerHTML = oResponse.responseText;
