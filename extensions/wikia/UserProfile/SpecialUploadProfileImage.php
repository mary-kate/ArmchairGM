...
class SkinSports extends Skin {
 ...
 function getMainPage(){
  ...
  $output .= '<h1>what\'s armchairgm?</h1>';
  $output .= '<p><b>ArmchairGM</b> is a user powered sports community run by a bunch of sports junkies.  Our community talks about sports, writes about sports, and contributes to our growing sports encyclopedia.</p>';
