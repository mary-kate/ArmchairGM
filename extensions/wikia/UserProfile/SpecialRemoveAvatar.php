...
$wgExtensionFunctions[] = 'wfSpecialRemoveAvatar';


function wfSpecialRemoveAvatar(){
  global $wgUser,$IP;
  include_once("includes/SpecialPage.php");
	...
	SpecialPage::addPage( new RemoveAvatar );
	global $wgMessageCache;
	$wgMessageCache->addMessage( 'removeavatar', 'Remove Avatar' );
}
