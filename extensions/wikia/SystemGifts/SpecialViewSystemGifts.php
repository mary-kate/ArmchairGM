...
$wgExtensionFunctions[] = 'wfSpecialViewSystemGifts';


function wfSpecialViewSystemGifts(){
	global $wgUser,$IP;
	...
	class ViewSystemGifts extends SpecialPage {
		...
		function execute(){
			...
			global $wgUser, $wgOut, $wgRequest, $IP, $wgMemc, $wgUploadPath, $wgMessageCache;
			...
			$wgOut->addScript("<link rel='stylesheet' type='text/css' href=\"/extensions/wikia/SystemGifts/SystemGift.css?{$wgStyleVersion}\"/>\n");

			//language messages
			require_once ( "$IP/extensions/wikia/SystemGifts/SystemGift.i18n.php" );
	...
	SpecialPage::addPage( new ViewSystemGifts );
	global $wgMessageCache,$wgOut;
	$wgMessageCache->addMessage( 'viewsystemgifts', 'View Awards' );
