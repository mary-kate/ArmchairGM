...
$wgExtensionFunctions[] = 'wfSpecialSystemGiftManagerLogo';

function wfSpecialSystemGiftManagerLogo(){
  global $wgUser,$IP;
...
function createThumbnail($imageSrc, $ext,$imgDest,$thumbWidth){
	...
	function showSuccess($status) {
		...
		$output .= "<tr><td valign=top style='color:#666666;font-weight:800'>Large</td><td><img src=/images/awards/sg_" . $this->gift_id . "_l." . $ext . "?ts=" .  rand()   . "></td></tr>";
		$output .= "<tr><td valign=top style='color:#666666;font-weight:800'>Medium-Large</td><td><img src=/images/awards/sg_" . $this->gift_id . "_ml." . $ext . "?ts=" .  rand()   . "></td></tr>";
		$output .= "<tr><td valign=top style='color:#666666;font-weight:800'>Medium</td><td><img src=/images/awards/sg_" . $this->gift_id . "_m." . $ext . "?ts=" .  rand()   . "></td></tr>";
		$output .= "<tr><td valign=top style='color:#666666;font-weight:800'>Small</td><td><img src=/images/awards/sg_" . $this->gift_id . "_s." . $ext . "?ts" .  rand()   . "=></td></tr>";
	...
	" ;
		...
		if($gift_image != ""){
			...
			$output .= "<tr><td><img src=\"/images/awards/" . $gift_image . "\" border=\"0\" alt=\"gift\" /></td></tr></table><br>";
		}
		$wgOut->addHTML($output);
 ...
 SpecialPage::addPage( new SystemGiftManagerLogo );
