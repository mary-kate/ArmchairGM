...
$wgExtensionFunctions[] = 'wfSpecialViewSystemGift';


function wfSpecialViewSystemGift(){
	global $wgUser,$IP;
	...
	class ViewSystemGift extends SpecialPage {
		...
		function execute(){
			...
			global $wgUser, $wgOut, $wgRequest, $wgMessageCache, $wgUploadPath, $IP;
	...
	SpecialPage::addPage( new ViewSystemGift );
