...
function ahah(url, target, delay, method, parameters) {
  if (method == undefined) { 
	  document.getElementById(target).innerHTML = "<p class='contacts-loading'>We are loading your contacts . . . Think of it as the seventh inning stretch.</p>";
  ...
  {
	  //document.getElementById(target).innerHTML = "<p class='contacts-loading'>We are loading your contacts . . . Think of it as the seventh inning stretch.</p>";
	  document.getElementById(target).innerHTML = "<p class='contacts-loading'>" + __contact_importer_waiting_message__ + "</p>";
	  document.emailform.reset();
	  if (window.XMLHttpRequest) {
		req = new XMLHttpRequest();
	  } else if (window.ActiveXObject) {
