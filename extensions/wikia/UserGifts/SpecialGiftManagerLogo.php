...
function createThumbnail($imageSrc, $ext,$imgDest,$thumbWidth){
	...
	function showSuccess($status) {
		...
		$output .= "<tr><td valign=top style='color:#666666;font-weight:800'>Large</td><td><img src=/images/awards/" . $this->gift_id . "_l." . $ext . "?ts=" .  rand()   . "></td></tr>";
		$output .= "<tr><td valign=top style='color:#666666;font-weight:800'>Medium-Large</td><td><img src=/images/awards/" . $this->gift_id . "_ml." . $ext . "?ts=" .  rand()   . "></td></tr>";
		$output .= "<tr><td valign=top style='color:#666666;font-weight:800'>Medium</td><td><img src=/images/awards/" . $this->gift_id . "_m." . $ext . "?ts=" .  rand()   . "></td></tr>";
		$output .= "<tr><td valign=top style='color:#666666;font-weight:800'>Small</td><td><img src=/images/awards/" . $this->gift_id . "_s." . $ext . "?ts" .  rand()   . "=></td></tr>";
