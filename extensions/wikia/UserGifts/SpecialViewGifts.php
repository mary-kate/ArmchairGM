...
function wfSpecialViewGifts(){
	...
	class ViewGifts extends SpecialPage {
		...
		function execute(){
			...
			global $wgUser, $wgOut, $wgRequest, $IP, $wgMemc, $wgMessageCache, $wgStyleVersion, $wgUploadPath;
			...
			$wgOut->addScript("<link rel='stylesheet' type='text/css' href=\"/extensions/wikia/UserGifts/UserGifts.css?{$wgStyleVersion}\"/>\n");

			//language messages
			require_once ( "$IP/extensions/wikia/UserGifts/UserGifts.i18n.php" );
	...
	$wgMessageCache->addMessage( 'viewgifts', 'View Gifts' );
}
