...
class MiniAjaxUploadForm extends UploadForm{
	...
	function showSuccess() {
		...
		$article->doEdit(  "{{Image Top}}\n\n{{Image Bottom}}\n[[Category:Profile Pictures]]\n[[Category:Profile Pictures by User {$user_name}]]", "profile image creation",EDIT_SUPPRESS_RC );
		
	
		
		//$sql = "SELECT img_description FROM `openserving_sports`.`image` WHERE img_name='". $this->mUploadSaveName ."'";
		//$res = $dbr->query($sql);
		//$row = $dbr->fetchObject( $res );
