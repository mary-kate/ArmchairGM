...
$wgExtensionFunctions[] = 'wfSpecialLinksHome';

function wfSpecialLinksHome(){
	global $wgUser,$IP;
	...
	class LinksHome extends UnlistedSpecialPage {
		...
		function getPopularArticles(){
			global $wgOut, $wgMemc, $wgBlogCategory;
		...
		function execute(){
			...
			**/
			...
			/*BUILD NEXT/PREV NAV
			**/
			$output .= 	"</div><div class=\"links-home-right\">";
	...
	SpecialPage::addPage( new LinksHome );
}
