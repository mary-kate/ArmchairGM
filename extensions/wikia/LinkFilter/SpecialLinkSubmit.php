...
$wgExtensionFunctions[] = 'wfSpecialLinkSubmit';

function wfSpecialLinkSubmit(){
	global $wgUser,$IP;
	...
	class LinkSubmit extends UnlistedSpecialPage {
		...
		function execute(){
			...
			global $IP, $wgUser, $wgOut, $wgRequest, $wgSitename, $wgMessageCache; 
	...
	SpecialPage::addPage( new LinkSubmit );
}
