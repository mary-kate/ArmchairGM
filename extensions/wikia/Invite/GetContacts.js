...
function getMailAccount (email) {
	...
	if(email)setMailAction(page)
}

function setMailAction(page){
	document.emailform.action="javascript:submit('/extensions/wikia/getmycontacts/" + page + ".php', 'POST')";
}
