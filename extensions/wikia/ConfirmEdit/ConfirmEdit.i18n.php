...
$wgConfirmEditMessages['en'] = array(
	'captcha-blank'             => "If you are trying to delete this page, please contact a [[Special:Listusers/sysop|admin]]. Blanking the page will not delete it. To confirm you wish to blank this page, please type the words that appear in this image. This is to protect against blanking bots.<br /> ([[Special:Captcha/help|more info]])",
	'captcha-edit'              => "Your edit includes new external links. To help protect against automated spam, please type in the words that appear in this image.<br /> ([[Special:Captcha/help|more info]])",
	'captcha-move'              => "As a protection against vandalism, you'll need to type in the words that appear in this image to move this page.<br /> ([[Special:Captcha/help|more info]])",
