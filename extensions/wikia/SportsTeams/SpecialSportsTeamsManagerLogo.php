...
$wgExtensionFunctions[] = 'wfSpecialSportsTeamsManagerLogo';

function wfSpecialSportsTeamsManagerLogo(){
  global $wgUser,$IP;
  include_once("includes/SpecialPage.php");


class SportsTeamsManagerLogo extends SpecialPage {
  ...
  function SportsTeamsManagerLogo(){
    UnlistedSpecialPage::UnlistedSpecialPage("SportsTeamsManagerLogo");
  }
...
function createThumbnail($imageSrc, $ext,$imgDest,$thumbWidth){
	...
	function showSuccess($status) {
		...
		$output .= "<tr><td valign=top style='color:#666666;font-weight:800'>" . wfMsgForContent( 'st_logo_size_large' ) . "</td><td><img src=images/team_logos/" . $this->team_id . "_l." . $ext . "?ts=" .  rand()   . "></td></tr>";
		$output .= "<tr><td valign=top style='color:#666666;font-weight:800'>" . wfMsgForContent( 'st_logo_size_medium' ) . "</td><td><img src=images/team_logos/" . $this->team_id . "_m." . $ext . "?ts=" .  rand()   . "></td></tr>";
		$output .= "<tr><td valign=top style='color:#666666;font-weight:800'>" . wfMsgForContent( 'st_logo_size_small' ) . "</td><td><img src=images/team_logos/" . $this->team_id . "_s." . $ext . "?ts" .  rand()   . "=></td></tr>";
		...
		$output .= " <a href=\"". Title::MakeTitle(NS_SPECIAL, "SportsTeamsManager")->escapeFullUrl("id={$this->team_id}") ."\">" . wfMsgForContent( 'st_logo_back_to_team' ) . "</a></td></tr>";
		$output .= "</table>";
	...
	" ;
		...
		if($team_logo != ""){
			...
			$output .= "<tr><td><img src=\"images/team_logos/" . $team_logo . "\" border=\"0\" alt=\"no logo\" /></td></tr></table><br>";
		}
		$wgOut->addHTML($output);
 ...
 SpecialPage::addPage( new SportsTeamsManagerLogo );
