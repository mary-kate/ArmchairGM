<?php
	...
	require_once ($IP.LOOKUPCONTRIBS_PATH."extensions/LookupContribs/SpecialLookupContribs.php") ;
	require_once ($IP.LOOKUPCONTRIBS_PATH."extensions/LookupContribs/LookupContribsCore.php") ;
