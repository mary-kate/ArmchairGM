...
#		$this->mCookieCheck = $wgRequest->getVal( 'wpCookieCheck' );
	...
	function processCreation() {
		...
		$m = "$this->mRealName";
		$m .= " <$this->mEmail> <http://$this->mWhichWiki.wikia.com/wiki/User:$this->mName> contacted Wikia about ";
	        $m .= "$this->mProblem.\n\n";
		$m .= "$this->mProblemDesc\n";
	...
	<td align='left'>
	<input tabindex='2' type='text' name=\"wpContactWikiName\" value=$wgDBname size='35' />
	</td>
