...
class CalendarClass {
  ...
  function displayMonth($month = 0, $year = 0) {
    ...
    $r .= '<tr><td colspan="7" align="center" valign="top" class="calendarHeader" style="border-bottom:1px #CED4CA solid;" ><span style="font-size:13pt; font-weight:bold;">';
    ...
    return '<table width="250" cellpadding="4" cellspacing="4" class="calendar" border="0" style="border: 1px #CED4CA solid;" >'.$r.'</table>';
  }
  ...
  function displayThreeMonths() {
    ...
    return '<table width="250"  cellpadding="4" cellspacing="4" class="calendar" border="0" style="border: 1px #CED4CA solid;" ><tr>'.$r.'</tr></table>';
  ...
  function displayYear() {
    ...
    return '<table width="250" cellpadding="4" cellpadding="4" class="calendar" border="0" style="border: 1px #CED4CA solid;" ><tr>'.$r.'</tr></table>';
  }
