...
function renderCreateForm($input, $args, &$parser){
	global $wgUser, $wgSiteView, $wgOut, $wgStyleVersion;
	...
	$wgOut->addScript("<script type=\"text/javascript\" src=\"/extensions/CreateForms/CreatePage.js?{$wgStyleVersion}\"></script>\n");
		$wgOut->addScript("<link rel=\"stylesheet\" type=\"text/css\" href=\"/extensions/CreateForms/CreatePage.css?{$wgStyleVersion}\" />\n");
