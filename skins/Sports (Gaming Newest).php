	 ...
	 //WELCOME MESSAGE
		 ...
		 $good_count = number_format(SiteStats::articles());
			...
			$output .= '<div class="welcome-message">';
				...
				$output .= '<h2>Gaming.Wikia is a community for passionate gamers.  Read, write, and talk about gaming.  Meet other gamers.  Rates games, platforms, and even cheats.  Earn points and receive gifts.</h2>';
		...
		$output .= '<div class="featured-ratings">';
			...
			$output .= "<p class=\"main-page-sub-links\"><a href=\"{$rate_players->getFullURL()}\">Rate More Games</a> or <a href=\"{$rate_teams->getFullURL()}\">Rate More Platforms</a></p>";
			$output .= $ratings_list;
		$output .= '</div>';
