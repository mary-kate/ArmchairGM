...
class SkinSearch extends Skin {
  ...
  function getSkinName() {
	...
	function getHeadScripts() {
		...
		$r .= "<script type=\"{$wgJsMimeType}\" src=\"http://alpha.search.wikia.com/scripts/prototype.js?{$wgStyleVersion}\"></script>\n";
		$r .= "<link rel='stylesheet' type='text/css' href=\"http://alpha.search.wikia.com/styles/search.css\"/>\n";
...
function footer() {
	...
	$footer .= "<div id=\"footer-container\">
		...
		<div id=\"footer-links\">
			...
			<a href=\"#\"> Help Us Make it Better</a>
		</div>
		<div id=\"footer-legal\">
...
function header() {
	...
	global $wgOut, $wgUser, $wgUser;
	
	$url = "http://alpha.search.wikia.com";
	
	$header="<script>
		function search(){
			window.location='{$url}/search/search-a.html#'+\$('q2').value;
			return false;
		}
	</script>
	<div id=\"header\">
	  <div id=\"header-container\">
	    ...
	    <div id=\"header-li-buttons\">";
	       	...
	       	if ($wgUser->isLoggedIn()) {
			$header .= "<div id=\"li-welcome\">Hello {$wgUser->getName()}</div>
		        <div id=\"li-logout\"><a href=\"{$url}/login/logout.html\">Logout?</a></div>";
			} else {
				$header .= "<div id=\"lo-register\"><a href=\"{$url}/account/addaccount.html\">Start a new account</a></div>
		        <div id=\"lo-login\"><a href=\"{$url}/login/login.html\">Login</a></div>";
			}

	    $header .= "</div>
	    <div id=\"tabs\">

	        <div class=\"tab-on\"><a href=\"{$url}/profile/profile.html\">Profile</a></div>
	        ...
	        <div class=\"tab-off\"><a href=\"{$url}/account/preferences.html\">Preferences</a></div>
